...
import com.bird.business.controller.IndexController;
...
@ContextConfiguration( locations = {"classpath:spring/spring-mvc.xml", "classpath:spring/mybatis-config.xml", "classpath:spring/spring-mybatis.xml", "classpath:spring/spring-shiro.xml"})
public class TbUserTest {

    @Autowired
    private IAdminManagerService userManagerService;

    @Autowired
    private IndexController userController;
    ...
    public void loginTest(){
        ...
        Set<String> roles = userManagerService.getRolesByUsername("admin");
        System.out.println(roles);

        Set<String> perms = userManagerService.getPermsByRoles("admin");
