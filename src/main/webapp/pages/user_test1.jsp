...
<head>
    ...
    <link rel="stylesheet" href="${ctx }/css/user_test1.css">
...
<script type="text/html" id="barDemo">
    <shiro:hasPermission name="stu:update1">
    <a class="layui-btn layui-btn-xs" lay-event="detail">查看</a>
    </shiro:hasPermission>
    <shiro:hasPermission name="stu:update1">
    <a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
    </shiro:hasPermission>
    <shiro:hasPermission name="stu:delete1">
...
<div class="top_tool">
    ...
    <shiro:hasPermission name="stu:add1">
    <!-- 新增按钮 -->
...
<script type="text/javascript" src="${ctx }/js/user_test1.js"></script>
</body>
</html>